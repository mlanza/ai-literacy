...
Artifacts marked with 🛠️ are **process artifacts**: reusable elements that describe *how* the work is done, not just what was done.
...
* 🛠️ = process artifact (generic or reusable)<br>
...
* ➡️ 📄 Final Daily Itinerary
* ⬅️ 📄 Trip Review Notes
* ⬅️ 🛠️ Reusable Templates or Prompts
