...
Calling for summaries is blackbelt stuff. Not just because you can keep working across sessions—but because it gives you compression. Where a chatbot might choke if handed several books you felt it needed for some work, it could easily swallow the pill if each were summarized in outlines. Compression gives you a way to zoom out and scale meaning without overloading the context window, to pass the **gist** without the weight.
